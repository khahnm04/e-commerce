      ...
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          <motion.h2
            ...
            className={cn([
              "font-[900] text-4xl lg:text-[64px] lg:leading-[75px] mb-5 lg:mb-8",
            ])}
          >
            HÃY KHÁM PHÁ PHONG CÁCH RIÊNG CỦA BẠN
          </motion.h2>
          <motion.p
          ...
          >
            Khám phá bộ sưu tập trang phục tinh tế của chúng tôi, được thiết kế tỉ mỉ để tôn lên cá tính và gu thời trang riêng của bạn.
          </motion.p>
          <motion.div
          // initial={{ y: "100px", opacity: 0 }}
          // whileInView={{ y: "0", opacity: 1 }}
