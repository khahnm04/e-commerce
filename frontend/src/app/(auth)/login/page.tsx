        ...
        <div className="bg-[#fff] rounded-[24px] md:w-[630px] w-[95%] mx-auto md:py-[90px] py-[40px] md:px-[57px] px-[20px]">
          ...
          >
            ...
            <div className="mb-[30px] flex justify-between">
              ...
              <Link
                className="font-[600] text-[18px] text-[var(--color-text)] opacity-60 hover:text-[var(--color-primary)] hover:opacity-100"
                href="#"
              >
                Quên mật khẩu?
              </Link>
            </div>
            <button className="w-full h-[56px] border-0 rounded-[8px] bg-[var(--color-primary)] opacity-90 font-[700] text-[20px]
             text-white cursor-pointer hover:opacity-100">
              Đăng Nhập
            </button>
          </form>
