...
public enum ErrorCode {
    ...
    PHONE_EXISTED(1106, "phone number already exists", HttpStatus.CONFLICT),
    PASSWORD_CONFIRMATION_MISMATCH(1107, "Password and confirm password do not match", HttpStatus.BAD_REQUEST),
    PASSWORD_NOT_MATCH(1006, "Password do not match", HttpStatus.BAD_REQUEST),
    PASSWORD_REQUIRED(1007, "Password cannot be blank", HttpStatus.BAD_REQUEST),
    ADDRESS_NOT_FOUND(1110, "Address not found", HttpStatus.NOT_FOUND),
