...
public enum ErrorCode {
    ...
    PHONE_NUMBER_REQUIRED(1002, "phoneNumber number cannot be blank", HttpStatus.BAD_REQUEST),
    EMAIL_NUMBER_REQUIRED(1003, "email number cannot be blank", HttpStatus.BAD_REQUEST),
    USERNAME_REQUIRED(1004, "username cannot be blank", HttpStatus.BAD_REQUEST),
